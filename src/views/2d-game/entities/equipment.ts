...
const EQUIPMENT_TEMPLATES: EquipTemplate[] = [
  ...
  },
  {
    ...
    icon: '⛑️',
    color: '#4ade80',
    baseStats: { hp: 25, def: 3 },
    description: 'Mũ sắt bảo vệ tốt hơn',
    possiblePassives: ['none', 'thorns'],
  },
  {
    id: 'ninja_mask',
    name: 'Mặt Nạ Ninja',
    ...
    icon: '🥷',
    color: '#60a5fa',
    baseStats: { hp: 35, speed: 0.3, critChance: 5 },
    description: 'Tăng tốc và crit',
    possiblePassives: ['none', 'speed_aura', 'crit_burst'],
  },
  {
    id: 'dragon_crown',
    name: 'Vương Miện Rồng',
    slot: 'head',
    rarity: 'epic',
    icon: '👑',
    color: '#c084fc',
    baseStats: { hp: 60, atk: 8, def: 5 },
    description: 'Vương miện của Rồng Cổ Đại',
    possiblePassives: ['lightning', 'crit_burst', 'none'],
  },
  {
    id: 'shadow_hood',
    name: 'Mũ Trùm Bóng Tối',
    slot: 'head',
    rarity: 'legendary',
    icon: '🌑',
    color: '#fb923c',
    baseStats: { hp: 80, atk: 12, critChance: 15 },
    description: 'Bóng tối bao phủ',
    possiblePassives: ['lifesteal', 'crit_burst', 'lightning'],
  },
  // CHEST
  {
    id: 'cloth_shirt',
  ...
  },
  {
    ...
    icon: '🦺',
    color: '#4ade80',
    baseStats: { def: 8, hp: 15 },
    description: 'Giáp da cứng cáp',
    possiblePassives: ['none', 'thorns'],
  },
  {
    id: 'chain_mail',
    ...
    icon: '🛡️',
    color: '#60a5fa',
    baseStats: { def: 15, hp: 30 },
    description: 'Giáp xích bảo vệ tốt',
    possiblePassives: ['thorns', 'mana_shield', 'none'],
  },
  {
    id: 'flame_plate',
    name: 'Giáp Lửa',
    ...
    icon: '🔥',
    color: '#c084fc',
    baseStats: { def: 22, hp: 40, atk: 5 },
    description: 'Giáp phủ ngọn lửa',
    possiblePassives: ['lightning', 'thorns', 'lifesteal'],
  },
  {
    id: 'divine_robe',
    name: 'Áo Thần Thánh',
    ...
    icon: '✨',
    color: '#fb923c',
    baseStats: { def: 30, hp: 60, manaRegen: 0.05 },
    description: 'Hồi mana mạnh',
    possiblePassives: ['mana_shield', 'lifesteal', 'lightning'],
  },
  // LEGS
  {
    id: 'cloth_pants',
    ...
    color: '#9ca3af',
    baseStats: { speed: 0.2 },
    description: 'Quần vải thoải mái',
    possiblePassives: ['none'],
  },
  {
    id: 'runner_pants',
    ...
    icon: '🩳',
    color: '#4ade80',
    baseStats: { speed: 0.5, def: 2 },
    description: 'Tăng tốc di chuyển',
    possiblePassives: ['none', 'speed_aura'],
  },
  {
    id: 'shadow_legs',
    name: 'Quần Bóng Đêm',
    ...
    icon: '🌙',
    color: '#60a5fa',
    baseStats: { speed: 0.8, def: 5, critChance: 3 },
    description: 'Nhanh như bóng đêm',
    possiblePassives: ['speed_aura', 'none'],
  },
  {
    id: 'storm_greaves',
    name: 'Quần Bão Tố',
    ...
    icon: '⚡',
    color: '#c084fc',
    baseStats: { speed: 1.0, def: 8, jumpPower: -1 },
    description: 'Sức mạnh bão tố',
    possiblePassives: ['lightning', 'speed_aura'],
  },
  {
    id: 'wind_hakama',
    name: 'Hakama Gió',
    ...
    icon: '🌪️',
    color: '#fb923c',
    baseStats: { speed: 1.5, def: 12, jumpPower: -2 },
    description: 'Bay như gió',
    possiblePassives: ['speed_aura', 'lightning', 'crit_burst'],
  },
  // GLOVES
  {
    id: 'cloth_gloves',
  ...
  },
  {
    ...
    icon: '🥊',
    color: '#4ade80',
    baseStats: { atk: 8, def: 2 },
    description: 'Đấm mạnh hơn',
    possiblePassives: ['none', 'lifesteal'],
  },
  {
    id: 'blade_gloves',
    name: 'Găng Lưỡi Dao',
    ...
    icon: '🗡️',
    color: '#60a5fa',
    baseStats: { atk: 15, critChance: 5 },
    description: 'Có lưỡi sắc',
    possiblePassives: ['crit_burst', 'lifesteal', 'none'],
  },
  {
    id: 'dragon_claws',
    name: 'Vuốt Rồng',
    ...
    icon: '🐉',
    color: '#c084fc',
    baseStats: { atk: 22, critChance: 10, speed: 0.2 },
    description: 'Vuốt rồng sắc bén',
    possiblePassives: ['lightning', 'crit_burst', 'lifesteal'],
  },
  {
    id: 'god_fists',
    name: 'Nắm Đấm Thần',
    ...
    icon: '💥',
    color: '#fb923c',
    baseStats: { atk: 35, critChance: 15, def: 5 },
    description: 'Sức mạnh thần thánh',
    possiblePassives: ['lightning', 'crit_burst', 'lifesteal'],
  },
  // BOOTS
  {
    ...
    icon: '👟',
    color: '#9ca3af',
    baseStats: { speed: 0.1, jumpPower: -0.3 },
    description: 'Dép rơm đơn giản',
    possiblePassives: ['none'],
  },
  {
    id: 'ninja_tabi',
    ...
    icon: '🥋',
    color: '#4ade80',
    baseStats: { speed: 0.3, jumpPower: -0.8 },
    description: 'Giày ninja',
    possiblePassives: ['none', 'speed_aura'],
  },
  {
    id: 'wind_boots',
    ...
    icon: '💨',
    color: '#60a5fa',
    baseStats: { speed: 0.5, jumpPower: -1.5, def: 3 },
    description: 'Nhảy cao chạy nhanh',
    possiblePassives: ['speed_aura', 'none'],
  },
  {
    id: 'thunder_boots',
    ...
    icon: '⚡',
    color: '#c084fc',
    baseStats: { speed: 0.8, jumpPower: -2, def: 5 },
    description: 'Nhanh như sấm',
    possiblePassives: ['lightning', 'speed_aura'],
  },
  {
    id: 'celestial_step',
    ...
    icon: '🌟',
    color: '#fb923c',
    baseStats: { speed: 1.2, jumpPower: -2.5, manaRegen: 0.03 },
    description: 'Bay bước trên mây',
    possiblePassives: ['speed_aura', 'mana_shield', 'lightning'],
  },
  // ACCESSORY
  {
    id: 'lucky_charm',
  ...
  },
  {
    ...
    icon: '💍',
    color: '#4ade80',
    baseStats: { atk: 5, hp: 10 },
    description: 'Nhẫn quý',
    possiblePassives: ['none', 'lifesteal'],
  },
  {
    id: 'mana_crystal',
    ...
    icon: '🔮',
    color: '#60a5fa',
    baseStats: { manaRegen: 0.05, hp: 20 },
    description: 'Hồi mana nhanh',
    possiblePassives: ['mana_shield', 'none'],
  },
  {
    id: 'phoenix_feather',
    ...
    icon: '🪶',
    color: '#c084fc',
    baseStats: { hp: 50, atk: 10, manaRegen: 0.03 },
    description: 'Sức mạnh tái sinh',
    possiblePassives: ['lifesteal', 'mana_shield', 'crit_burst'],
  },
  {
    id: 'dragon_heart',
    name: 'Tim Rồng',
    ...
    icon: '❤️‍🔥',
    color: '#fb923c',
    baseStats: { hp: 80, atk: 20, def: 10, critChance: 10 },
    description: 'Trái tim rồng',
    possiblePassives: ['lightning', 'lifesteal', 'crit_burst'],
  },
]
...
export function findUpgradeMaterials(
  base: EquipmentConfig,
  inventory: EquipmentConfig[],
): EquipmentConfig[] {
...
export function upgradeEquipment(
  ...
  if (base.stats.speed)
    newStats.speed = Math.round((base.stats.speed / prevBoost) * boost * 100) / 100
  if (base.stats.jumpPower)
    newStats.jumpPower = Math.round((base.stats.jumpPower / prevBoost) * boost * 100) / 100
  if (base.stats.manaRegen)
    newStats.manaRegen = Math.round((base.stats.manaRegen / prevBoost) * boost * 100) / 100
  if (base.stats.critChance)
    newStats.critChance = Math.round((base.stats.critChance / prevBoost) * boost)
...
export function createEquipmentDrop(
  x: number,
  y: number,
...
export function drawEquipmentDrop(
  ...
  ctx.fillStyle = `${rarityColor}${Math.floor(glowAlpha * 255)
    .toString(16)
    .padStart(2, '0')}`
  ctx.beginPath()
  ctx.arc(dx + drop.w / 2, dy + drop.h / 2 + bob, 16, 0, Math.PI * 2)
  ctx.fill()

  ctx.strokeStyle = rarityColor
  ctx.lineWidth = 2
  ctx.beginPath()
  ctx.arc(dx + drop.w / 2, dy + drop.h / 2 + bob, 12, 0, Math.PI * 2)
  ctx.stroke()
  ...
  if (drop.life < 120 && Math.floor(Date.now() / 200) % 2 === 0) {
    ctx.textAlign = 'left'
    return
  }
  ...
  if (eq.rarity === 'epic' || eq.rarity === 'legendary') {
    ...
    for (let i = 0; i < sparkleCount; i++) {
      ...
      ctx.fillStyle = rarityColor
      ctx.fillRect(
        dx + drop.w / 2 + Math.cos(angle) * 14 - 1,
        dy + drop.h / 2 + bob + Math.sin(angle) * 14 - 1,
        2,
        2,
      )
    }
...
export function getActivePassives(
  equipped: Partial<Record<EquipSlot, EquipmentConfig | null>>,
): PassiveType[] {
